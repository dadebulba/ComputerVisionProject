...
//int CodecContext::avcodec_decode_video	(AVCodecContext * avctx, AVFrame * picture, int * 	got_picture_ptr, uint8_t * 	buf, int buf_size)
//{
//    int ret;
//
//    *got_picture_ptr= 0;
...
boost::optional<Frame> CodecContext::DecodeFrame(Packet& pkt)
{
...
int CodecContext::GetChannels() const { return get()->channels;}
void CodecContext::SetChannels(int channels) {get()->channels = channels;}
