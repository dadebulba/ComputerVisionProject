...
IplImageWrapper getSubImage(const IplImageWrapper& srcImg, const Box<int>& srcBox, const SizeGeometry<int>& dstSize, bool fillBorders, bool setMask)
{
