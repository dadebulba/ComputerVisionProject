...
#include "../geometry/SizeGeometry.h"
#include <boost/random.hpp>

IplImageWrapper getSubImage(const IplImageWrapper& srcImg, const Box<int>& srcBox, const SizeGeometry<int>& dstSize, bool fillBorders = false, bool setMask = false);
